defmodule FullCircleWeb.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FullCircleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FullCircleWeb.Gettext, "errors", msg, opts)
    end
  end
end
